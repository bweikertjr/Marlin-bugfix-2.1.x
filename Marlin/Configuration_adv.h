 ...
 */
#define FAN_MIN_PWM 050  //laser2024, I don't believe this is being used
#define FAN_MAX_PWM 255  //laser2024, I don't believe this is being used
...
#define HOMING_BUMP_MM      { 5, 5, 5 }       // (linear=mm, rotational=°) Backoff from endstops after first bump, laser2024
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate), laser2024
...
#define AXIS_RELATIVE_MODES { false, false, false } //laser2024
...
#define STEP_STATE_X HIGH //laser2024
#define STEP_STATE_Y HIGH //laser2024
#define STEP_STATE_Z HIGH //laser2024
 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC 120 //laser2024
#define DISABLE_IDLE_X  //laser2024
#define DISABLE_IDLE_Y  //laser2024
#define DISABLE_IDLE_Z    // Disable if the nozzle could fall onto your printed part!, //laser2024
...
#define DEFAULT_MINIMUMFEEDRATE       0.0     // (mm/s. °/s for rotational-only moves) Minimum feedrate. Set with M205 S. laser2024?
#define DEFAULT_MINTRAVELFEEDRATE     0.0     // (mm/s. °/s for rotational-only moves) Minimum travel feedrate. Set with M205 T. laser2024?

// Minimum time that a segment needs to take as the buffer gets emptied
#define DEFAULT_MINSEGMENTTIME        20000   // (µs) Set with M205 B. laser2024?
 ...
 */
#define MULTISTEPPING_LIMIT   16  //: [1, 2, 4, 8, 16, 32, 64, 128], laser2024?
...
#define MICROSTEP_MODES { 16, 16, 16, 16, 16, 16 } // [1,2,4,8,16], laser2024?
...
#define BABYSTEPPING  //laser2024
  ...
  #define BABYSTEP_MILLIMETER_UNITS         // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps, laser2024 - for focusing
  #define BABYSTEP_MULTIPLICATOR_Z  0.1     // (steps or mm) Steps or millimeter distance for each Z babystep, laser2024
 ...
 */
//#define G29_RETRY_AND_RECOVER //laser2024
#if ENABLED(G29_RETRY_AND_RECOVER)
  #define G29_MAX_RETRIES 2 //laser2024
  #define G29_HALT_ON_FAILURE //laser2024
  /**
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                   // Requires ~3226 bytes, laser2024
#if ENABLED(ARC_SUPPORT)
  #define MIN_ARC_SEGMENT_MM      0.1 // (mm) Minimum length of each arc segment, laser2024
  #define MAX_ARC_SEGMENT_MM      1.0 // (mm) Maximum length of each arc segment, laser2024
  #define MIN_CIRCLE_SEGMENTS    72   // Minimum number of segments in a complete circle, laser2024
  //#define ARC_SEGMENTS_PER_SEC 50   // Use the feedrate to choose the segment length
  #define N_ARC_CORRECTION       25   // Number of interpolated segments between corrections, laser2024
...
#define MIN_STEPS_PER_SEGMENT 6 //laser2024
 ...
 */
  ...
  #define HOLD_MULTIPLIER    0.5  // Scales down the holding current from run current, laser2024

  /**
   * Interpolate microsteps to 256
   * Override for each driver with <driver>_INTERPOLATE settings below
   */
  #define INTERPOLATE      true //laser2024?

  #if AXIS_IS_TMC_CONFIG(X)
    #define X_CURRENT       400        // (mA) RMS current. Multiply by 1.414 for peak current, laser2024
    #define X_CURRENT_HOME  X_CURRENT  // (mA) RMS current for sensorless homing
    #define X_MICROSTEPS     8        // 0..256, laser2024 from MKS Board settings.
    ...
    #define Y_CURRENT       400  //laser2024- change current to Dave's motors
    #define Y_CURRENT_HOME  Y_CURRENT
    #define Y_MICROSTEPS     8  //laser2024 from MKS Board settings
    ...
    #define Z_CURRENT       400 //laser2024
    #define Z_CURRENT_HOME  Z_CURRENT
    #define Z_MICROSTEPS     16 //laser2024
   ...
   */
  #define TMC_USE_SW_SPI  //laser2024?
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_12V        // All axes (override below), laser2024 - change to 24volt?
  ...
  #define X_HYBRID_THRESHOLD     100  // [mm/s], laser2024 uncomment to improve speed?
  //#define X2_HYBRID_THRESHOLD    100  
  #define Y_HYBRID_THRESHOLD     100  // laser2024 uncomment to improve speed?
  //#define Y2_HYBRID_THRESHOLD    100  // laser2024 uncomment to improve speed?
 ...
 //#define E7_HYBRID_THRESHOLD     30
  ...
  #define DIAG_JUMPERS_REMOVED  //laser2024 - to supress warning when compiling
...
/**
 * Spindle & Laser control  //LASER2024
 *
...
#define LASER_FEATURE  //laser2024
#if ANY(SPINDLE_FEATURE, LASER_FEATURE)
  #define SPINDLE_LASER_ACTIVE_STATE    LOW    // Set to "HIGH" if SPINDLE_LASER_ENA_PIN is active HIGH

  #define SPINDLE_LASER_USE_PWM                // Enable if your controller supports setting the speed/power
  #if ENABLED(SPINDLE_LASER_USE_PWM)
    #define SPINDLE_LASER_PWM_INVERT    false  // Set to "true" if the speed/power goes up when you want it to go slower  //laser2024?
    #define SPINDLE_LASER_FREQUENCY     1000   // (Hz) Spindle/laser frequency (only on supported HALs: AVR, ESP32, and LPC)  //laser2024 WAS 2500, this works when connected to PA2 to ground
    #define SPINDLE_LASER_PWM_PIN PA2            // Hardware PWM laser TTL input
    //#define SPINDLE_LASER_ENA_PIN 4      
          // CO2 PSU enable input
  ...
  #define AIR_ASSIST                         // Air Assist control with G-codes M8-M9
    ...
    #define AIR_ASSIST_PIN            PA1    // Override the default Air Assist pin ; laser2024 
  #endif
   ...
   */
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX], laser2024 questionable
    ...
    #if ENABLED(SPINDLE_LASER_USE_PWM)
      #define SPEED_POWER_INTERCEPT       0    // (%) 0-100 i.e., Minimum power percentage, laser2024
      #define SPEED_POWER_MIN             0    // (%) 0-100, laser2024
      #define SPEED_POWER_MAX           100    // (%) 0-100, laser2024
      #define SPEED_POWER_STARTUP        80    // (%) M3/M4 speed/power default (with no arguments), laser2024
    #endif

    // Define the minimum and maximum test pulse time values for a laser test fire function
    #define LASER_TEST_PULSE_MIN           1   // (ms) Used with Laser Control Menu //laser2024
    #define LASER_TEST_PULSE_MAX         999   // (ms) Caution: Menu may not show more than 3 characters  //laser2024

    #define SPINDLE_LASER_POWERUP_DELAY   50   // (ms) Delay to allow the spindle/laser to come up to speed/power //laser2024
    #define SPINDLE_LASER_POWERDOWN_DELAY 50   // (ms) Delay to allow the spindle to stop //laser2024
    ...
    */
    #define LASER_SAFETY_TIMEOUT_MS     1000   // (ms)  laser2024
     ...
     */
    #define LASER_POWER_SYNC  // laser2024
     ...
     */
    #define LASER_POWER_TRAP  //laser2024
 ...
 */
//#define LASER_SYNCHRONOUS_M106_M107   //BW2024
 ...
 */
#define COOLANT_CONTROL  // laser2024
#if ENABLED(COOLANT_CONTROL)
  #define COOLANT_MIST_PIN   PA6    // Override the default coolant mist pin, laser2024
  #define COOLANT_FLOOD_PIN  PA5    // Override the default coolant flood pin, laser2024
//#if ENABLED(COOLANT_CONTROL)
  #define COOLANT_MIST                // Enable if mist coolant is present, laser2024
  #define COOLANT_FLOOD               // Enable if flood coolant is present, laser2024 
...
#define GCODE_CASE_INSENSITIVE  // Accept G-code sent to the firmware in lowercase, laser2024
 ...
 */
#define DEBUG_FLAGS_GCODE //laser2024
...
#define GCODE_MOTION_MODES  // Remember the motion mode (G0 G1 G2 G3 G5 G38.X) and apply for X Y Z E F, etc., laser2024
...
// M42 - Set pin states
//
#define DIRECT_PIN_CONTROL  //laser2024 for debugging only

//
// M43 - display pin status, toggle pins, watch pins, watch endstops & toggle LED, test servo probe
//
#define PINS_DEBUGGING  //laser2024 for debugging only
