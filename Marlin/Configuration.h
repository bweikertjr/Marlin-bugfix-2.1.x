...
#define STRING_CONFIG_H_AUTHOR "(Dave G., Laser)" // Who made the changes.
 ...
 */
#define X_DRIVER_TYPE  TMC5160  //laser2024
#define Y_DRIVER_TYPE  TMC5160  //laser2024
#define Z_DRIVER_TYPE  TMC2209  //laser2024
...
#define ENDSTOPPULLUPS  //laser2024
...
//#define ENDSTOPPULLDOWNS  //laser2024
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW  //laser2024
//#define X_MAX_ENDSTOP_HIT_STATE LOW  //laser2024
#define Y_MIN_ENDSTOP_HIT_STATE LOW  //laser2024
//#define Y_MAX_ENDSTOP_HIT_STATE LOW  //laser2024
#define Z_MIN_ENDSTOP_HIT_STATE LOW  //laser2024
//#define Z_MAX_ENDSTOP_HIT_STATE LOW  //laser2024
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE LOW  //laser2024

// Enable this feature if all enabled endstop pins are interrupt-capable.
// This will remove the need to poll the interrupt pins, saving many CPU cycles.
#define ENDSTOP_INTERRUPTS_FEATURE  //laser2024
 ...
 * :[2,3,4,5,6,7]
 */
//#define ENDSTOP_NOISE_THRESHOLD 2 //laser2024?
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 50.595, 50.631, 640 } //laser2024

/**
 * Enable support for M92. Disable to save at least ~530 bytes of flash.
 */
#define EDITABLE_STEPS_PER_UNIT //laser2024
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 20 }  //laser2024
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100 } //laser2024
 ...
 */
#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E acceleration for printing moves, //laser2024
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration for retracts, //laser2024
#define DEFAULT_TRAVEL_ACCELERATION   3000    // X, Y, Z acceleration for travel (non printing) moves, //laser2024
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  //laser2024?

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING  //laser2024
 ...
 */
//#define Z_MIN_PROBE_PIN -1  //laser2024
 ...
 */
#define FIX_MOUNTED_PROBE //laser2024
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 }  //laser2024, need to define

// Enable and set to use a specific tool for probing. Disable to allow any tool.
//#define PROBING_TOOL 0  //laser2024?
#ifdef PROBING_TOOL
...
#define PROBING_MARGIN 10 //laser2024

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (133*60)  //laser2024

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (4*60)  //laser2024

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 2) //laser2024
 ...
 */
//#define MULTIPLE_PROBING 2  //laser2024, change to understand behavior
//#define EXTRA_PROBING    1  //laser2024, change to understand behavior
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   10 // (mm) Z Clearance for Deploy/Stow, //laser2024
#define Z_CLEARANCE_BETWEEN_PROBES  5 // (mm) Z Clearance between probe points, //laser2024
#define Z_CLEARANCE_MULTI_PROBE     5 // (mm) Z Clearance between multiple probes, //laser2024
#define Z_PROBE_ERROR_TOLERANCE     3 // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET), //laser2024
//#define Z_AFTER_PROBING           5 // (mm) Z position after probing is done

#define Z_PROBE_LOW_POINT          -2 // (mm) Farthest distance below the trigger-point to go before stopping, //laser2024

// For M851 provide ranges for adjusting the X, Y, and Z probe offsets //laser2024
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  //laser2024
...
// :{ 0:'Low', 1:'High' }
#define X_ENABLE_ON 0 //laser2024
#define Y_ENABLE_ON 0 //laser2024
#define Z_ENABLE_ON 0 //laser2024
...
#define INVERT_X_DIR false  //laser2024
#define INVERT_Y_DIR true   //laser2024
#define INVERT_Z_DIR false  //laser2024
...
// :[-1,1]
#define X_HOME_DIR -1 //laser2024
#define Y_HOME_DIR -1 //laser2024
#define Z_HOME_DIR -1 //laser2024
//#define I_HOME_DIR -1
//#define J_HOME_DIR -1
//#define K_HOME_DIR -1
//#define U_HOME_DIR -1
...
#define X_BED_SIZE 1000 //laser2024
#define Y_BED_SIZE 800  //laser2024

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0 //laser2024
#define Y_MIN_POS 0 //laser2024
#define Z_MIN_POS 0 //laser2024
#define X_MAX_POS X_BED_SIZE  //laser2024
#define Y_MAX_POS Y_BED_SIZE  //laser2024
#define Z_MAX_POS 200 //laser2024
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define MIN_SOFTWARE_ENDSTOPS //laser2024
#if ENABLED(MIN_SOFTWARE_ENDSTOPS)
  #define MIN_SOFTWARE_ENDSTOP_X  //laser2024
  #define MIN_SOFTWARE_ENDSTOP_Y  //laser2024
  #define MIN_SOFTWARE_ENDSTOP_Z  //laser2024
...
#define MAX_SOFTWARE_ENDSTOPS //laser2024
#if ENABLED(MAX_SOFTWARE_ENDSTOPS)
  #define MAX_SOFTWARE_ENDSTOP_X  //laser2024
  #define MAX_SOFTWARE_ENDSTOP_Y  //laser2024
  #define MAX_SOFTWARE_ENDSTOP_Z  //laser2024
...
#define AUTO_BED_LEVELING_BILINEAR  //laser2024
 ...
 */
#define DEBUG_LEVELING_FEATURE  //laser2024
   ...
   */
  #define ENABLE_LEVELING_FADE_HEIGHT //laser2024?  likely don't need
   ...
   */
  #define SEGMENT_LEVELED_MOVES   //laser2024
  //#define LEVELED_SEGMENT_LENGTH 5.0 // (mm) Length of all segments (except the last one) laser2024

  /**
   * Enable the G26 Mesh Validation Pattern tool.
   */
  //#define G26_MESH_VALIDATION //laser2024??
  ...
  #define GRID_MAX_POINTS_X 4  //laser2024
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X //laser2024
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID //laser2024
 ...
 */
#define Z_SAFE_HOMING//laser2024??
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60) } //laser2024

// Validate that endstops are triggered on homing moves
//#define VALIDATE_HOMING_ENDSTOPS  //laser2024
...
// :[1,2,3,4,5,6,7,8]
#define NUM_M106_FANS 2   //laser2024, this was changed due to compiling issues - too many fans?

// Use software PWM to drive the fan, as for the heaters. This uses a very low frequency
// which is not as annoying as with the hardware PWM. On the other hand, if this frequency
// is too low, you should also increment SOFT_PWM_SCALE.
//#define FAN_SOFT_PWM  //laser2024
...
// :[0,1,2,3,4,5,6,7]
//#define SOFT_PWM_SCALE 0  //laser2024
...
//#define SERVO_DELAY { 300 } //laser2024, commented out only
